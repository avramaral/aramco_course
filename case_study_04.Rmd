...
Now, let's remove `coarse_aggregate`.
...
\begin{align*}
\texttt{response}_i &= `r round(model$coefficients[[1]], 3)` + `r round(model$coefficients[[2]], 3)`\texttt{var1}_i + `r round(model$coefficients[[3]], 3)`\texttt{var2}_i + `r round(model$coefficients[[4]], 3)`\texttt{var5}_i
\end{align*}
