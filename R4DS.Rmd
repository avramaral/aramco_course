...
You can download the `.csv` file [here](./datasets/r4ds.csv). And you read the file in the following way
```{r}
...
Also, we will need the following libraries
